# -*- coding: utf-8 -*-
"""Watermark_fine_tuning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1bU0UvYzG7XoBusEa4k5iepTaYeiiaHY9
"""
...
test = data_list["test"]
fine_tune, test = train_test_split(test, test_size=0.5, random_state=281)
...
fine_tune_dat = myDataset(fine_tune, TEXT,LABEL)

TEXT.build_vocab(train_dat,vectors='glove.6B.300d',max_size=25000)
LABEL.build_vocab(train_dat,)

bs = 32
train_iter, valid_iter, test_iter, fine_tune_iter = torchtext.data.BucketIterator.splits((train_dat, val_dat, test_dat, fine_tune_dat), 
...
for epoch in range(10):
    ...
    epoch_loss, epoch_accuracy = fit(epoch,model,fine_tune_iter,phase='training')
